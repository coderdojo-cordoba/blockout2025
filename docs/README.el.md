...
## 🤝 Ελάτε στη Διεθνή μας Ομάδα!

**Καλούμε όλους τους νέους προγραμματιστές από το CoderDojo και το Code Club!** 🌍

Δημιουργούμε μια διεθνή ομάδα για να κάνουμε το BlockOut II προσβάσιμο σε παίκτες σε όλο τον κόσμο σε **23 γλώσσες**. Είτε είστε αρχάριος είτε έμπειρος προγραμματιστής, υπάρχει θέση για εσάς!

**Τι θα μάθετε:**
- 🌐 Διεθνοποίηση (i18n) και τοπικοποίηση
- 💻 Ανάπτυξη παιχνιδιών σε C++
- 🔧 Συστήματα κατασκευής και CI/CD
- 🤝 Παγκόσμια συνεργασία

**Πώς να συνεισφέρετε:**
- 📝 Μεταφράστε το παιχνίδι στη γλώσσα σας
- 🎨 Δημιουργήστε τοπικοποιημένες γραμματοσειρές και γραφικά
- 🧪 Δοκιμάστε σε διαφορετικές πλατφόρμες
- 🔨 Βελτιώστε το σύστημα κατασκευής
- 🎮 Προσθέστε νέες λειτουργίες

👉 **[Διαβάστε το CONTRIBUTING.md](../CONTRIBUTING.md) για να ξεκινήσετε!**
